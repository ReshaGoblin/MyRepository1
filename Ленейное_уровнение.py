...
for j in range(0, a): # Цикл for колличество итерации в зависимости от размера массива
    mas=input().split() #Создаем список со входными значениями  
    if j==a-1: # Если введена последняя строка то выполнить следующее
        for i in range(0, a): # Цикл for колличество итерации в зависимости от размера массива
